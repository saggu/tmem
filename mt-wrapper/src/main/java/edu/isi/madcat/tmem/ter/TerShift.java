 ...
 * 
 * TERshift.java v1 Matthew Snover (snover@cs.umd.edu)
 */
...
public class TerShift {
  ...
  public List<Comparable<?>> shifted = null; // The words we shifted
  ...
  TerShift(int _start, int _end, int _moveto, int _newloc, List<Comparable<?>> _shifted) {
    start = _start;
    end = _end;
    moveto = _moveto;
    newloc = _newloc;
